...
const BRUTE_STATUS_META: Record<string, { label: string; color: string; bg: string; border: string }> = {
  ...
  call_cut_rudely:         { label: "They picked up but cut the call rudely", color: "#991b1b", bg: "linear-gradient(135deg,#fef2f2,#fee2e2,#fff1f2)", border: "#fca5a5" },
