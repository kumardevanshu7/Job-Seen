...
const STATUS_STYLES: Record<DisplayStatus, StatusMeta> = {
  ...
  call_busy: {
    label: "Call Busy - Try Again",
    color: "#b45309",
    bg: "linear-gradient(135deg, #fffbeb 0%, #fef3c7 50%, #ffedd5 100%)",
    border: "#fcd34d",
    dot: "linear-gradient(135deg, #f59e0b 0%, #d97706 100%)",
  },
  call_later: {
    label: "Wait - Call me later",
    color: "#0e7490",
    bg: "linear-gradient(135deg, #ecfeff 0%, #cffafe 50%, #e0f2fe 100%)",
    border: "#67e8f9",
    dot: "linear-gradient(135deg, #22d3ee 0%, #0891b2 100%)",
  },
  switched_off: {
    label: "Switched off",
    color: "#475569",
  ...
  site_resume_email: {
    label: "Go to site — Send resume on email",
    color: "#0f766e",
    bg: "linear-gradient(135deg, #f0fdfa 0%, #ccfbf1 45%, #ecfeff 100%)",
    border: "#5eead4",
